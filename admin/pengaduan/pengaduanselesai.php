				...
				<table class="table mb-0">
					...
					<tbody>
					    ...
					    <?php 
						 ...
						 $pengaduan = mysqli_query($koneksi, "SELECT * FROM pengaduan JOIN masyarakat ON pengaduan.nik = masyarakat.nik WHERE status = 'selesai' ORDER BY tgl_pengaduan DESC") or die (mysqli_error($koneksi));
